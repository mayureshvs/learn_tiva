...
/* --> led */
extern xdc_Void led(xdc_UArg,xdc_UArg);
#ifdef __IAR_SYSTEMS_ICC__
    #pragma data_alignment=8
#endif
...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[8091];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/mayuresh/Desktop/New folder (2)/RTOS-TUTORIALS/Debug/configPkg/package/cfg/empty_min_pem4f");
...
ti_sysbios_knl_Task_Object__ ti_sysbios_knl_Task_Object__table__V[2] = {
    {/* instance#0 */
        ...
        0,  /* stackHeap */
        ((xdc_Void(*)(xdc_UArg,xdc_UArg))((xdc_Fxn)led)),  /* fxn */
        ((xdc_UArg)(0x0)),  /* arg0 */
        ((xdc_UArg)(0x0)),  /* arg1 */
        ((xdc_Ptr)0),  /* env */
        ((void*)0),  /* hookEnv */
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1f9b;
