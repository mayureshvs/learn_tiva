...
linker.cmd: package/cfg/empty_min_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/empty_min_pem4fcfg.cmd\)\"$""\"C:/Users/mayuresh/Desktop/New folder (2)/RTOS-TUTORIALS/.config/xconfig_empty_min/\1\""' package/cfg/empty_min_pem4f.xdl > $@
